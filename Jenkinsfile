...
pipeline {
	...
	environment {
		...
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/avr128db48-cnano-opamp-demo-fw-studio.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/avr128db48-cnano-opamp-demo-fw-studio.git'
